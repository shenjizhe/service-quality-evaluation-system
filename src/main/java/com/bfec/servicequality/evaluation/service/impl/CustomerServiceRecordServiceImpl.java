 ...
 *
 * @File: CustomerServiceRecordServiceImpl.java
 * @Author: JasonShen
...
import com.bfec.servicequality.evaluation.mapper.CustomerServiceRecordMapper;
 ...
 */
@Service
public class CustomerServiceRecordServiceImpl
    extends BaseServiceImpl<CustomerServiceRecord>
    implements CustomerServiceRecordService {

    @Resource
    private CustomerServiceRecordMapper mapper;
