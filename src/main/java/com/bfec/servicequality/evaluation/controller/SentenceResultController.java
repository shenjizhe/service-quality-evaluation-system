 ...
 *
 * @File: SentenceResultController.java
 * @Author: JasonShen
...
@Slf4j
@RestController
@RequestMapping("/sentence-results")
@Api(tags = "语句识别结果")
public class SentenceResultController extends BaseController<SentenceResult> {
    @Autowired
    private SentenceResultService service;
     ...
     * 语句识别结果-批量查询
     */
    @ApiOperation(value = "语句识别结果-批量查询", notes = "")
    @GetMapping("/batch/")
    public Result<List<SentenceResult>> batchSelect(
     ...
     * 语句识别结果-批量添加
     */
    @ApiOperation(value = "语句识别结果-批量添加", notes = "")
    @PostMapping("/batch/")
    public Result<Integer> batchInsert(
            @RequestBody List<SentenceResult> records
    ) {
     ...
     * 语句识别结果-批量删除
     */
    @ApiOperation(value = "语句识别结果-批量删除", notes = "")
    @DeleteMapping("/batch/")
     ...
     * 语句识别结果-添加
     */
    @ApiOperation(value = "语句识别结果-添加", notes = "")
    @PostMapping("/")
    public Result<Integer> singleInsert(
            @RequestBody SentenceResult record
    ) {
     ...
     * 语句识别结果-修改
     */
    @ApiOperation(value = "语句识别结果-修改", notes = "")
    @PutMapping("/")
     ...
     * 语句识别结果-删除
     */
    @ApiOperation(value = "语句识别结果-删除", notes = "")
    @DeleteMapping("/{id}/")
